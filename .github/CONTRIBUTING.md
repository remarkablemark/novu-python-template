...
[Fork](https://github.com/remarkablemark/novu-python-template/fork) and then clone the repository:

```sh
# replace <USER> with your username
git clone git@github.com:<USER>/novu-python-template.git
```
...
Push to your fork and create a [pull request](https://github.com/remarkablemark/novu-python-template/compare/).
...
- [ ] Write tests that pass [CI](https://github.com/remarkablemark/novu-python-template/actions/workflows/test.yml).
...
```sh
pip install --index-url https://test.pypi.org/simple/ --no-deps novu-python-template
```
